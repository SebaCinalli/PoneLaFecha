...
namespace UI.Desktop
{
 ...
 this.lblTitulo.Name = "lblTitulo";
  ...
  this.btnReporteSolicitudes.BackColor = Color.LightBlue;
      ...
      this.btnReporteSolicitudes.Location = new Point(80, 90);
     this.btnReporteSolicitudes.Name = "btnReporteSolicitudes";
  this.btnReporteSolicitudes.Size = new Size(240, 50);
...
this.btnReporteSolicitudes.Click += BtnReporteSolicitudes_Click;
 ...
 this.btnReporteIngresos.BackColor = Color.LightGreen;
    this.btnReporteIngresos.Font = new Font("Microsoft Sans Serif", 12F, FontStyle.Regular, GraphicsUnit.Point);
         this.btnReporteIngresos.Location = new Point(80, 155);
      this.btnReporteIngresos.Name = "btnReporteIngresos";
   this.btnReporteIngresos.Size = new Size(240, 50);
...
this.btnReporteServicios.Font = new Font("Microsoft Sans Serif", 12F, FontStyle.Regular, GraphicsUnit.Point);
 this.btnReporteServicios.Location = new Point(80, 220);
 this.btnReporteServicios.Name = "btnReporteServicios";
    this.btnReporteServicios.Size = new Size(240, 50);
      this.btnReporteServicios.TabIndex = 3;
      this.btnReporteServicios.Text = "Servicios Más Solicitados\n(con gráfico circular)";
 this.btnReporteServicios.UseVisualStyleBackColor = false;
     this.btnReporteServicios.Click += BtnReporteServicios_Click;

       // btnReporteADO
      this.btnReporteADO.BackColor = Color.LightYellow;
    this.btnReporteADO.Font = new Font("Microsoft Sans Serif", 12F, FontStyle.Regular, GraphicsUnit.Point);
       this.btnReporteADO.Location = new Point(80, 285);
     this.btnReporteADO.Name = "btnReporteADO";
 this.btnReporteADO.Size = new Size(240, 50);
        this.btnReporteADO.TabIndex = 4;
   this.btnReporteADO.Text = "Estadísticas del Sistema";
 this.btnReporteADO.UseVisualStyleBackColor = false;
 this.btnReporteADO.Click += BtnReporteADO_Click;
  ...
  // btnCerrar
   this.btnCerrar.Font = new Font("Microsoft Sans Serif", 10F, FontStyle.Regular, GraphicsUnit.Point);
     this.btnCerrar.Location = new Point(140, 355);
 ...
 this.ClientSize = new Size(400, 420);
     this.Controls.Add(this.btnCerrar);
      this.Controls.Add(this.btnReporteADO);
