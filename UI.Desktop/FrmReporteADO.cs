...
this.grpClientes.Location = new Point(550, 90);
 ...
 this.lblTotalClientes.Size = new Size(180, 60);
   ...
   // lblInfo
 this.lblInfo.BackColor = Color.LightYellow;
   this.lblInfo.BorderStyle = BorderStyle.FixedSingle;
    ...
    this.lblInfo.Location = new Point(550, 230);
            this.lblInfo.Name = "lblInfo";
this.lblInfo.Padding = new Padding(10);
            this.lblInfo.Size = new Size(220, 140);
            this.lblInfo.TabIndex = 4;
  this.lblInfo.Text = "?? Información Técnica:\n\n" +
        "• ListarConADO() usa SqlConnection y SqlCommand\n\n" +
      "• ObtenerTotalClientesConADO() usa ExecuteScalar\n\n" +
          "• Cumple requisito de ADO.NET";
  ...
  this.btnActualizar.BackColor = Color.LightBlue;
        this.btnActualizar.Font = new Font("Microsoft Sans Serif", 10F, FontStyle.Bold, GraphicsUnit.Point);
            this.btnActualizar.Location = new Point(250, 390);
   ...
   // btnCerrar
            ...
            this.btnCerrar.Location = new Point(410, 390);
