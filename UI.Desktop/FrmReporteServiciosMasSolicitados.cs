 ...
 this.lblTotalBarras = new Label();
   ...
   this.lblTitulo.Name = "lblTitulo";
    ...
    this.lblTitulo.TabIndex = 0;
            this.lblTitulo.Text = "Servicios Más Solicitados";
...
this.btnCerrar.Name = "btnCerrar";
 ...
 // FrmReporteServiciosMasSolicitados
  ...
  this.StartPosition = FormStartPosition.CenterScreen;
     this.Text = "Servicios Más Solicitados";
          ...
          try
{
  ...
  var solicitudesConfirmadas = solicitudes.Where(s => s.Estado == "Confirmada").ToList();
  ...
  // Contar servicios por tipo
    ...
    int totalDJs = 0;
          ...
          foreach (var solicitud in solicitudesConfirmadas)
          {
var solicitudCompleta = await _logicaSolicitud.GetByIdAsync(solicitud.IdSolicitud);
     if (solicitudCompleta != null)
       {
           totalSalones += solicitudCompleta.SalonSolicitudes?.Count ?? 0;
  totalBarras += solicitudCompleta.BarraSolicitudes?.Count ?? 0;
            totalDJs += solicitudCompleta.DjSolicitudes?.Count ?? 0;
              totalGastro += solicitudCompleta.GastroSolicitudes?.Count ?? 0;
                  }
                }
    ...
    for (int i = 0; i < valores.Length; i++)
{
    ...
    g.DrawString(texto, new Font("Arial", 10, FontStyle.Regular), 
          Brushes.Black, leyendaX + 35, leyendaY + (i * espacioLeyenda) + 5);
            ...
            // Título del gráfico
            g.DrawString("Distribución de Servicios Solicitados", 
                ...
                var saveFileDialog = new SaveFileDialog
  {
      ...
      FileName = $"Reporte_ServiciosMasSolicitados_{DateTime.Now:yyyyMMdd}.txt"
      };

     if (saveFileDialog.ShowDialog() == DialogResult.OK)
     {
             var contenido = $"REPORTE DE SERVICIOS MÁS SOLICITADOS\n";
